...
export default function BackofficeVehicleServicesPage() {
  ...
  const loadJobs = useCallback(async () => {
    setLoading(true);
    try {
      const res = await vehicleServicesApi.getJobs({ stationId: stationId || undefined, from, to, limit: 100 });
      setJobs(res.items);
    } catch {
      // ignore
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h1 className="text-xl font-bold">Vehicle Services — All Stations</h1>
      ...
      <div className="bg-white rounded-xl border">
        <div className="px-4 py-3 border-b">
          <h2 className="font-medium text-sm">Service Jobs History</h2>
        </div>
